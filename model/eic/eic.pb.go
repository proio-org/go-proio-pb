...
type CaloShower struct {
	...
	Origin *ObservedPos `protobuf:"bytes,1,opt,name=origin" json:"origin,omitempty"`
...
var fileDescriptor_d1620427b20c8703 = []byte{
	...
	,
}
...
func (m *CaloShower) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Origin != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintEic(dAtA, i, uint64(m.Origin.Size()))
		n18, err := m.Origin.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	if len(m.Observation) > 0 {
		dAtA20 := make([]byte, len(m.Observation)*10)
		var j19 int
		for _, num := range m.Observation {
			for num >= 1<<7 {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintEic(dAtA, i, uint64(j19))
		i += copy(dAtA[i:], dAtA20[:j19])
	}
	if len(m.Hypothesis) > 0 {
		for _, msg := range m.Hypothesis {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintEic(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *TrackSegment) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Vertex != nil {
		...
		i++
		i = encodeVarintEic(dAtA, i, uint64(m.Vertex.Size()))
		n21, err := m.Vertex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.Poq != nil {
		...
		n22, err := m.Poq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	...
	if m.Curvature != nil {
		...
		n23, err := m.Curvature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.Magfield != nil {
		...
		n24, err := m.Magfield.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *ObservedPos) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Mean != nil {
		...
		n25, err := m.Mean.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *RandVar) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Sigma != nil {
		...
		n26, err := m.Sigma.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
